...
public class FansDAOImpl implements FansDAO {
    ...
    public List<FansPo> findAllFansByF_user_id(int f_user_id) {
        ...
        try {
            ...
            pstmt = conn.prepareStatement("select * from fans where f_user_id = ?");
    ...
    public boolean checkFans(int user_id, int fan_id) {
        ...
        try {
            con = dbConn.getConnection();
            pstmt = con.prepareStatement("select * from fans where f_fan_id = ? and f_user_id = ?");
