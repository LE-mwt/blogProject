                ...
                <ul>
                    ...
                    <ul class="am-dropdown-content tpl-dropdown-content">
                        ...
                        <li class="tpl-dropdown-menu-messages">
                            <a href="javascript:;" class="tpl-dropdown-menu-messages-item am-cf">
                                <div class="menu-messages-ico">
                                    <img src="admin_assets/img/user02.png" alt="">
                                </div>
                                <div class="menu-messages-time">
                                    5天前
                                </div>
    ...
    <div class="left-sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-link">
                <a href="./adminIndexServlet" class="active">
        ...
        <div class="container-fluid am-cf">
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                    <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 后台管理首页
                    </div>
                    <p class="page-header-description">博客，又音译为部落阁或部落格，通过本网站可发表张贴个人文章，文章以网页形式出现。</p>
                </div>
        ...
        <div class="row-content am-cf">
            <div class="row  am-cf">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-4">
                    <div class="widget am-cf" style="height:173px">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">网站博文总浏览量</div>
                        ...
                        <div class="widget-body am-fr">
                            <div class="am-fl">
                                <div class="widget-fluctuation-period-text" style="font-size: 50px">
                                    ${articleviewcount}
